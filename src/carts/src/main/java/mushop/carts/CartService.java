...
public class CartService implements Service {
    ...
    private static final Set<RequestMethod> PATCH = 
       Collections.singleton(Http.RequestMethod.create("PATCH"));
     ...
     * POST /{cartId}
     * 
     * Adds or updates a cart.  If the cartId does not exist, a new cart is added.  
     * If the cartId does exist, the given cart is merged in to the existing one.
     * This method is used to add additional items to a cart. 
     */
