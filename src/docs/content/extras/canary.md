...
## Deploy storefront beta
 ...
 - Create a deployment with the below config and name it mushop-storefrontv2.
   Note: We will use the same labels of storefront original.
...
## Testing
 ...
 Try to refresh the URL and you would see two different storefront UI's (original and beta with review feature) in a round robin fashion (because we have set 50:50 as the weight).
 
{{% alert style="warning" icon="info" %}}
You can also increase the percentage of traffic from 50:50 to 90:10. We could also do more
 focused canary testing using Header and URI matching [refer](https://istio.io/latest/blog/2017/0.1-canary/#focused-canary-testing) 
