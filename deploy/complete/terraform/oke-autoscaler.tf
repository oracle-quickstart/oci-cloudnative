...
resource "oci_identity_dynamic_group" "cluster_autoscaler_dg" {
  name           = "cluster-autoscaler-dg-${random_string.deploy_id.result}"
  description    = "Cluster Autoscaler Dynamic Group"
...
resource "oci_identity_policy" "cluster_autoscaler_policies" {
  name           = "cluster-autoscaler-policies-${random_string.deploy_id.result}"
  description    = "Cluster Autoscaler Policies"
