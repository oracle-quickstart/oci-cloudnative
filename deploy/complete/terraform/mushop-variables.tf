...
variable "mushop_mock_mode_all" {
  default     = false
  description = "If enabled, will not provision ATP Database, Object Storage, or Streaming. The services will connect to an in-memory database, and the data will not persist"
}
