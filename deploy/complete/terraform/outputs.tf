...
output "grafana_admin_password" {
  value = var.grafana_enabled ? nonsensitive(data.kubernetes_secret.mushop_utils_grafana.0.data.admin-password) : "* grafana not deployed *" # Required for TF 0.15, as automatically generate an error if is not marked as sensitive
